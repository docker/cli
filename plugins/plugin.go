...
func RunPlugin(dockerCli CLI, plugin *cobra.Command, meta metadata.Metadata) error {
...
func newPluginCommand(dockerCli CLI, plugin *cobra.Command, meta metadata.Metadata) *cli.TopLevelCommand {
	name := plugin.Name()
