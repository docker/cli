...
|:---------------------------------|:---------|:--------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------|
| `--config`                       | `string` | `/Users/david/.docker`          | Location of client config files                                                                                                       |
...
| `--tlscacert`                    | `string` | `/Users/david/.docker/ca.pem`   | Trust certs signed only by this CA                                                                                                    |
| `--tlscert`                      | `string` | `/Users/david/.docker/cert.pem` | Path to TLS certificate file                                                                                                          |
| `--tlskey`                       | `string` | `/Users/david/.docker/key.pem`  | Path to TLS key file                                                                                                                  |
