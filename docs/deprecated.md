...
|------------|------------------------------------------------------------------------------------------------------------------------------------|------------|--------|
| Deprecated | [Legacy links environment variables](#legacy-links-environment-variables)                                                          | v29.0      | v30.0  |
...
with the environment variable `DOCKER_KEEP_DEPRECATED_LEGACY_LINKS_ENV_VARS=1` set.

Support for legacy links environment variables, as well as `DOCKER_KEEP_DEPRECATED_LEGACY_LINKS_ENV_VARS`
will be dropped in v30.0.
