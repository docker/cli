...
type fakeClient struct {
	...
	imageLoadFunc    func(input io.Reader, opts types.ImageLoadOptions) (types.ImageLoadResponse, error)
...
func (cli *fakeClient) ImageSave(_ context.Context, images []string, opts types.ImageSaveOptions) (io.ReadCloser, error) {
	if cli.imageSaveFunc != nil {
		return cli.imageSaveFunc(images, opts)
	}
...
func (cli *fakeClient) ImageLoad(_ context.Context, input io.Reader, opts types.ImageLoadOptions) (types.ImageLoadResponse, error) {
	if cli.imageLoadFunc != nil {
		return cli.imageLoadFunc(input, opts)
	}
