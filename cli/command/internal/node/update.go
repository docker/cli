...
func newUpdateCommand(dockerCLI cli.Cli) *cobra.Command {
...
func runUpdate(ctx context.Context, dockerCLI cli.Cli, flags *pflag.FlagSet, nodeID string) error {
...
func updateNodes(ctx context.Context, dockerCLI cli.Cli, nodes []string, mergeNode func(node *swarm.Node) error, success func(nodeID string)) error {
