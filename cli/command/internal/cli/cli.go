...
type Cli interface {
	...
	Initialize(opts *cliflags.ClientOptions, ops ...CLIOption) error
	HooksEnabled() bool
	TelemetryClient
}
...
// NewDockerCli returns a [Cli] instance with all operators applied on it.
// It applies by default the standard streams, and the content trust from
// environment.
func NewDockerCli(ops ...CLIOption) (Cli, error) {
