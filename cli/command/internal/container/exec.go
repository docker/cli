...
func init() {
	commands.RegisterCommand(newExecCommand)
}
...
//
// deprecated: this helper function will be removed in the next release
func NewExecOptions() ExecOptions {
	return newExecOptions()
}
...
//
// deprecated: commands should never be directly imported
func RunExec(ctx context.Context, dockerCLI command.Cli, containerIDorName string, options ExecOptions) error {
	return runExec(ctx, dockerCLI, containerIDorName, options)
}
