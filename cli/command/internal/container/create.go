...
import (
	...
	"github.com/docker/cli/cli/command/internal/image"
...
func init() {
	commands.RegisterCommand(newCreateCommand)
}
...
// newCreateCommand creates a new cobra.Command for `docker create`
var newCreateCommand = commands.MaybeHideLegacy(func(dockerCli command.Cli) *cobra.Command {
