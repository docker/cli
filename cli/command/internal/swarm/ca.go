...
import (
	...
	"github.com/docker/cli/cli/command/internal/swarm/progress"
...
func newCACommand(dockerCLI cli.Cli) *cobra.Command {
	opts := caOptions{}
...
func runCA(ctx context.Context, dockerCLI cli.Cli, flags *pflag.FlagSet, opts caOptions) error {
...
func attach(ctx context.Context, dockerCLI cli.Cli, opts caOptions) error {
	client := dockerCLI.Client()
