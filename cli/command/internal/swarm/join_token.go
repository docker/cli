...
func newJoinTokenCommand(dockerCLI cli.Cli) *cobra.Command {
...
func runJoinToken(ctx context.Context, dockerCLI cli.Cli, opts joinTokenOptions) error {
...
func printJoinCommand(ctx context.Context, dockerCLI cli.Cli, nodeID string, worker bool, manager bool) error {
	apiClient := dockerCLI.Client()
