...
func init() {
	commands.RegisterCommand(newLogoutCommand)
}

// NewLogoutCommand creates a new `docker logout` command
//
// Deprecated: Do not import commands directly. They will be removed in a future release.
func NewLogoutCommand(dockerCLI cli.Cli) *cobra.Command {
...
func runLogout(ctx context.Context, dockerCLI cli.Cli, serverAddress string) error {
