...
func init() {
	commands.RegisterCommand(newLoginCommand)
}
...
func NewLoginCommand(dockerCLI cli.Cli) *cobra.Command {
...
func verifyLoginOptions(dockerCLI cli.Streams, opts *loginOptions) error {
	if opts.password != "" {
...
func runLogin(ctx context.Context, dockerCLI cli.Cli, opts loginOptions) error {
...
func loginWithStoredCredentials(ctx context.Context, dockerCLI cli.Cli, authConfig registrytypes.AuthConfig) (msg string, _ error) {
...
func loginWithUsernameAndPassword(ctx context.Context, dockerCLI cli.Cli, opts loginOptions, defaultUsername, serverAddress string) (msg string, _ error) {
...
func loginWithDeviceCodeFlow(ctx context.Context, dockerCLI cli.Cli) (msg string, _ error) {
...
func loginClientSide(ctx context.Context, auth registrytypes.AuthConfig) (*registrytypes.AuthenticateOKBody, error) {
	...
	token, err := svc.Auth(ctx, &auth, cli.UserAgent())
	if err != nil {
		return nil, err
	}
