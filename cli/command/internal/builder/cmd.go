...
func init() {
	...
	commands.RegisterCommand(func(c cli.Cli) *cobra.Command {
...
func NewBuilderCommand(dockerCLI cli.Cli) *cobra.Command {
...
//
// Deprecated: Do not import commands directly. They will be removed in a future release.
func NewBakeStubCommand(dockerCLI cli.Streams) *cobra.Command {
