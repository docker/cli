...
func TestConfigList(t *testing.T) {
	...
	cmd := newConfigListCommand(fakeCli)
	assert.NilError(t, cmd.Execute())
	golden.Assert(t, fakeCli.OutBuffer().String(), "config-list-sort.golden")
}
...
func TestConfigListWithQuietOption(t *testing.T) {
	...
	assert.NilError(t, cmd.Execute())
	golden.Assert(t, fakeCli.OutBuffer().String(), "config-list-with-quiet-option.golden")
}
...
func TestConfigListWithConfigFormat(t *testing.T) {
	...
	cmd := newConfigListCommand(fakeCli)
	assert.NilError(t, cmd.Execute())
	golden.Assert(t, fakeCli.OutBuffer().String(), "config-list-with-config-format.golden")
}
...
func TestConfigListWithFormat(t *testing.T) {
	...
	assert.NilError(t, cmd.Execute())
	golden.Assert(t, fakeCli.OutBuffer().String(), "config-list-with-format.golden")
}
...
func TestConfigListWithFilter(t *testing.T) {
	...
	assert.NilError(t, cmd.Execute())
	golden.Assert(t, fakeCli.OutBuffer().String(), "config-list-with-filter.golden")
}
