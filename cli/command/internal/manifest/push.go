...
func newPushListCommand(dockerCLI cli.Cli) *cobra.Command {
	opts := pushOpts{}
...
func runPush(ctx context.Context, dockerCLI cli.Cli, opts pushOpts) error {
...
func pushList(ctx context.Context, dockerCLI cli.Cli, req pushRequest) error {
