...
func resolveServiceImageDigestContentTrust(dockerCLI cli.Cli, service *swarm.ServiceSpec) error {
...
func trustedResolveDigest(dockerCLI cli.Cli, ref reference.NamedTagged) (reference.Canonical, error) {
	...
	notaryRepo, err := trust.GetNotaryRepository(dockerCLI.In(), dockerCLI.Out(), cli.UserAgent(), repoInfo, &authConfig, "pull")
	if err != nil {
