...
func newCreateCommand(dockerCLI cli.Cli) *cobra.Command {
...
func runCreate(ctx context.Context, dockerCLI cli.Cli, flags *pflag.FlagSet, opts *serviceOptions) error {
