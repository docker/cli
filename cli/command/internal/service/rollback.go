...
func newRollbackCommand(dockerCLI cli.Cli) *cobra.Command {
...
func runRollback(ctx context.Context, dockerCLI cli.Cli, options *serviceOptions, serviceID string) error {
