...
func newScaleCommand(dockerCLI cli.Cli) *cobra.Command {
...
func runScale(ctx context.Context, dockerCLI cli.Cli, options *scaleOptions, args []string) error {
...
func completeScaleArgs(dockerCLI cli.Cli) func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
