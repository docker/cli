...
func runPrune(ctx context.Context, dockerCLI cli.Cli, options pruneOptions) error {
...
func dryRun(ctx context.Context, dockerCLI cli.Cli, options pruneOptions) (string, error) {
	var (
		errs     []error
		warnings []string
	)
