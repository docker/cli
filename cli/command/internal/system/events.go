...
func NewEventsCommand(dockerCLI cli.Cli) *cobra.Command {
	return newEventsCommand(dockerCLI)
}

// newEventsCommand creates a new cobra.Command for `docker events`
var newEventsCommand = commands.MaybeHideLegacy(func(dockerCLI cli.Cli) *cobra.Command {
...
func runEvents(ctx context.Context, dockerCLI cli.Cli, options *eventsOptions) error {
