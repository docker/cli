...
func init() {
	commands.RegisterCommand(newVersionCommand)
}
...
// information.
func newClientVersion(contextName string, dockerCLI cli.Cli) clientVersion {
	v := clientVersion{
...
func NewVersionCommand(dockerCLI cli.Cli) *cobra.Command {
...
func runVersion(ctx context.Context, dockerCLI cli.Cli, opts *versionOptions) error {
	var err error
...
func prettyPrintVersion(dockerCLI cli.Cli, vd versionInfo, tmpl *template.Template) error {
