...
// LoadFromEnv decodes a JSON encoded string into configEnv
//
// Unexpected fields will cause a parsing error.
func (c *configEnv) LoadFromEnv(envConfig string) error {
