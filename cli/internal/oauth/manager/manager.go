...
func (m *OAuthManager) LoginDevice(ctx context.Context, w io.Writer) (*oauth.TokenResult, error) {
	...
	_, _ = fmt.Fprintf(w, "Submit your device code here: %s\n", strings.Split(state.VerificationURI, "?")[0])
	_, _ = fmt.Fprint(w, "\n\033[1mPress ENTER\033[0m to open your browser\n")
...
func (m *OAuthManager) RefreshToken(ctx context.Context, refreshToken string) (*oauth.TokenResult, error) {
