...
type ImageAPIClient interface {
	...
	// TODO: Change variadic opts into a single parameter
	ImageHistory(ctx context.Context, image string, opts ...image.HistoryOptions) ([]image.HistoryResponseItem, error)

	// TODO: Change variadic opts into a single parameter
	ImageSave(ctx context.Context, imageIDs []string, opts ...image.SaveOptions) (io.ReadCloser, error)

	// TODO: Replace ImageLoad with ImageLoadVNext
	ImageLoad(ctx context.Context, input io.Reader, quiet bool) (image.LoadResponse, error)
	ImageLoadVNext(ctx context.Context, input io.Reader, opts image.LoadOptions) (image.LoadResponse, error)
}
